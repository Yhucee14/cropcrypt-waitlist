...
const Hero = () => {
  return (
    <div>
      <div className="flex xx:py-4 sm:py-2 xx:flex-col sm:flex-col justify-between items-center">
        <div className="flex px-4 flex-col">
          <div className="font-bold flex flex-col justify-start xx:leading-10 sm:leading-10 sm:py-3 text-2xl sm:text-3xl  text-[#0F2816]">
          ...
          <div className=" py-4 flex xx:justify-start sm:justify-center w-[650px] sm:px-5 font-normal leading-6 xx:text-md sm:text-lg">
          ...
          <div className="flex py-2 gap-2 px-36 sm:px-0 justify-start sm:justify-center flex-row">
            <div className="flex py-1 justify-center sm:px-5 items-center">
              <Link to="/waitlist">
        ...
        <div className="xx:pb-16 sm:pb-0 lg:pb-10">
